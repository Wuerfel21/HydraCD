...
The PDasm program disassembles Propeller (PChip) Binary images into its constituting ASM instructions. No attempt is made to identify Data elements or SPIN code as of this release.
...
output may be redirected into a file using the '>' operator.
	example: 'pdasm.exe asteroids.bin 0 256 > out.txt'


4. Known Issues -

a) No attempt to detect data or spin code sections at this time
b) No attempt to infer correct conditional modifiers at this time.
c) Some instructions are not correctly handled at this time, namely:
	CLKSET
	COGID
	COGINIT
	COGSTOP
