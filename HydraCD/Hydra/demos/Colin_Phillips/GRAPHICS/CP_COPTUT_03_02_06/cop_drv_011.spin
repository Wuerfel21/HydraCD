...
code_map_s0             shl     r4, #0                                          ' Pan Y+Scanline * VRAM Width
                        ...
                        mov     r5, #16                                         ' 16 tiles
                        movd    code_map_d0, #data_start+scanline_buf + 0
                        movd    code_map_d1, #data_start+scanline_buf+1 + 0
                        movd    code_map_d2, #data_start+scanline_buf+2 + 0
                        movd    code_map_d3, #data_start+scanline_buf+3 + 0                          
