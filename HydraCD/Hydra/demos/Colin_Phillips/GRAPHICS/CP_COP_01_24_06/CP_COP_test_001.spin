...
CON
  ...
  PARAMCOUNT        = 14
  COP_ARG_OFFSET    = $1ff0           ' use this space to communicate with the cog
...
VAR
  ...
  long  game_partycolor

'///////////////////////////////////////////////////////////////////////
' OBJECT DECLARATION SECTION ///////////////////////////////////////////
'///////////////////////////////////////////////////////////////////////
OBJ
  tv    : "cop_tv_drv_010.spin"       ' instantiate a tv object
  gr    : "cop_graphics_drv_010.spin" ' instantiate a graphics object
  sd    : "sound.spin"                ' instantiate a sound object
...
PUB start | i, dx, dy, x, y, t, t2
  ...
  repeat i from 0 to 64
    colors[i] := $00001010 * (i+4) & $F + $CB0E0E02
  ...
  ' HANDLE GAME STATES
    case game_state
      ...
      GAMESTATE_PLAY:                                   ' GAME IN PLAY          ////////////////
        ...
        if(frame<32)
          LONG[COP_ARG_OFFSET] := $00080000 + $00100000 * frame&15          
      ...
      GAMESTATE_DEAD:                                   ' GAME OVER             ////////////////
        gr.colorwidth(1+(frame>>4)&1,1)
        gr.plot(x, y)
        repeat t from 0 to 1
          gr.arc(x, y, frame, frame, frame*32, 256, 32+1, t)
