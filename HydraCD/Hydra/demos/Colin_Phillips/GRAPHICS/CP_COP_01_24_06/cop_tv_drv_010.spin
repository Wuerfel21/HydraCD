...
superfield              mov     taskptr,#tasks          'reset tasks
        ...
        if_nc           mov     phaseflip,phasemask
                        ...
                        'add    test_var_CUR,test_var_ADD
                        'and    test_var_CUR,test_var_AND2
                        rdlong  test_var_CUR,var_cop_arg_offset ' copy arg[0] into cur
'                       
'
' Field
'
...
:color                  xor     tile,colortable
                        ...
                        and     tile,test_var_AND
                        or      tile,test_var_CUR
                        add     test_var_CUR,test_var_ADD
                        and     test_var_CUR,test_var_AND2
...
test_var_AND            long    $ff0fffff
test_var_CUR            long    $00080000
test_var_ADD            long    $00100000
test_var_AND2           long    $00f80000
var_cop_arg_offset      long    COP_ARG_OFFSET
'
'
