...
'
' DESCRIPTION:
' Outputs a colored rainbow pattern NTSC with a resolution of 16 pixels per hline
' (1 WAITVID per line) 262-18-18-24 visible scanlines.
' also Scrolls in sync to frame count, and in sync to debug LED.
'
' NOTES:
...
OBJ
  cop   : "cop_drv_002.spin"          ' instantiate a cop object
