...
VERSION 5.1
Modified by JT Cook to remove PCM routines to free up memory, stop and release routines
...
CON
  ...
  'removed PCM which drops it from 7 to 5
  SIZE_OF_PARAM_CHDAT      = 5 'in longs: pending_shape, pending_freq, pending_duration, pending_volume, pending_amp_env, pending_pcm_start and pending_pcm_end
...
loop
                    ...
                    and     temp,#%1111                 'Look at the low 4-bits of sound_clock
...
get_volume          mov     mult_x,0
        ...
        if_e        jmp     #mixer                              'If yes, jump to mixer
                  ...
                  '  add     pcm_start_ptr,       #SIZE_OF_CHDAT  - removed
...
'                    shl     mixed_sample,#1           'Crank volume high as possible for 9 channels without clipping
                  ...
                  '  mov     pcm_start_ptr,       #channel_data+CHDAT_PCM_START - removed
...
channel_data
                        ...
                        long    0,0,0,0,0,0,0,0,21,0,0,0  'Channel 7

                        long    0,0,0,0,0,0,0,0,21,0,0,0  'Channel 8
'                        long    0,0,0,0,0,0,0,0,21,0,0,0  'Channel 9
'                        long    0,0,0,0,0,0,0,0,21,0,0,0  'Channel 10
'                        long    0,0,0,0,0,0,0,0,21,0,0,0  'Channel 11
end_of_channel_data
...
shape_jmp_table         long    generate_shape_silent
                        ...
                        'long    generate_shape_pcm_8bit_11khz - removed
                        
sound_clock             long    1                  'Increments at approx 11KHz (ie. once per driver iteration)
...
'_pending_pcm_start      long    0 - removed 
