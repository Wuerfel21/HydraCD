...
''
'' Sixth release - cleaned up the source a little. Nothing different functional or game wise.
...
PUB start      | i,ii,iii
  ...
  ' The rendering engine needs 5 cogs, then we have the tv cog, and also the SPIN cog which
  '  is always loaded. This leaves one free cog which has been devoted to sound.
  cog_total := 5
  cog_number := 0
  repeat
...
PUB Calc_Speed |  z
'takes the MPH speed and converts it to speed in the game for values between 0 and 10
