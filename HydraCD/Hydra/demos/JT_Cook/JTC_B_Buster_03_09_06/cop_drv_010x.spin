...
' VERSION 1.0x (modified version)
' mods:
' - map is shifted right by 8 pixels and is 256-16 pixels in width instead of 256
' - fixed first scanline garbage.
...
' data_start    = $130                                  ' FORCE DATA START
  ...
  obj_n           = 24 '40 '40 '32 ' 32 '20 '12         ' Number of Objects
...
' this like mad.
                        ...
                        cmp     v_scanline, #active_fields-1 wz                 ' dont prepare last scanline - leave it blank
            if_z        jmp     #skip_sprites
...
code_map_s0             shl     r4, #0                                          ' Pan Y+Scanline * VRAM Width
                        ...
                        mov     r5, #15                 ' 15 tiles MOD for hydraman
                        movd    code_map_d0, #data_start+scanline_buf + 2
                        movd    code_map_d1, #data_start+scanline_buf+1 + 2
                        movd    code_map_d2, #data_start+scanline_buf+2 + 2
                        movd    code_map_d3, #data_start+scanline_buf+3 + 2                          
...
code_spr_d if_nc        cmp     0, r1                   wc                      ' CARRY = Sprite.H<(Y-Sprite.Y)
      if_c              jmp     #skip_spr_hline                                 ' (4) JMP / (5) no JMP
                        ...
                        movs   :modifier_s, code_spr_s4
                        add    :modifier_s, #1                                  ' OBJ_OFFSET_M is OBJ_OFFSET_I + 1
                        nop
:modifier_s             mov    v_add, 0
                        mov    r2, v_add
                        shl    v_add, #8
                        or     v_add, r2
                        mov    r2, v_add
