...
open INPUT, "hydra_color.bmp" or die "Can't open hydra_color.bmp!\n";
binmode INPUT;
read INPUT, $_, 54;
...
open INPUT, $filename or die "Can't open source image!\n";
binmode INPUT;
...
if($colorused == 0)
{
	printf("Warning: BMP Field Color Used is 0. Assuming 256.\n\n");
	$colorused = 256;
}
