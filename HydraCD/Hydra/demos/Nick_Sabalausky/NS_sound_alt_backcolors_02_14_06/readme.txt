...
NS_sound_demo_041_black.spin (Top File):
   Identical to NS_sound_demo_040.spin, except uses black
   as the background color.

NS_sound_demo_041_darkred.spin (Top File):
   Identical to NS_sound_demo_040.spin, except uses dark red
   as the background color.

NS_sound_demo_041_darkred_allgreenkeys.spin (Top File):
   Identical to NS_sound_demo_040.spin, except uses dark red
   as the background color, and uses green for all the key
   highlighting (both keyboard and mouse).
