...
' etc. to detect certain button combinations
'
' VERSION: x.x
...
' demo looks for the sequence "UP, UP, LEFT, RIGHT, START" when it detects
' the sequence it changes the tilemap, if the sequence is detected again,
' the tile map is returned to original
'
'//////////////////////////////////////////////////////////////////////////////
...
' level 1 displayed when sequence is matched 
