...
PUB start | i, j,k,l,dx, dy,t, t2, x0, y0,orientation,tile,status,line_complete
  ...
  ' HANDLE GAME STATES
    case game_state
      GAMESTATE_INIT:                                   ' INITIALIZATION        ////////////////
        ...
        gr.colorwidth(1,0)
        gr.text(40,SCREEN_HEIGHT/2+20 ,@title_string)
        gr.text(40,SCREEN_HEIGHT/2-20 ,@start_string)

        case game_level
          0:
            gr.text(40,SCREEN_HEIGHT/2-40 ,@level_easy)
          1:
            gr.text(40,SCREEN_HEIGHT/2-40 ,@level_normal)
          2:
            gr.text(40,SCREEN_HEIGHT/2-40 ,@level_hard)      
      ...
      GAMESTATE_DEAD:
        ...
        gr.textmode(3,1,6,6)
        gr.colorwidth(1,0)
        gr.text(40,SCREEN_HEIGHT/2 ,@gameover_string)
