...
-Fixed HYDRA Binary output. was outputting 12-bit word SX chip values instead of 8-bit Hydra compatible values.
-Added -colorxor operation. XOR's all color pixels with the specified value, defaultly 0x00.
