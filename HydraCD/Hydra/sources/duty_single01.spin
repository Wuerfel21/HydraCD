...
asm_entry		movi	ctra, #CNT_MODE_DUTY_SINGLE | CNT_MUXSEL_X1	' set counter mode to pll duty with x1 on the mux
...
_frq			long	$8000_0000		'maximum count rate, overflows every clock
