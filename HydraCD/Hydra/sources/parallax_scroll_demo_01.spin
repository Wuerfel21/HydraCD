' /////////////////////////////////////////////////////////////////////////////
' TITLE: MAPPY_TEMPLATE_002.SPIN - Mappy Import Test Template with scrolling
'
...
' This version allows no scrolling and supports maps that are exactly 16x12 only
' but allows you to scroll with the gamepad
'
' VERSION: 1.0
...
tile_data:      "alienplanet_tile_data.spin" ' "pitfall_tile_data.spin" ' <----- MODIFY THIS LINE BY INSERTING YOUR OWN MAP2SPIN OUTPUT FILE HERE!!!!!
