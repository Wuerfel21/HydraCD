' //////////////////////////////////////////////////////////////////////
' Simple polygon rendering demo with translation, without double buffering
' to show "flicker", but with delay to minimize flicker
...
PUB start | i, dx, dy, x, y
  ...
  ' primary onscreen buffer only now
  gr.start
  ...
  repeat while TRUE
    ...
    'erase the image 
    Draw_Polygon2(@fighter_poly, 12, 0, ship_x, ship_y )
    ...
    ' render graphics directly to screen
    Draw_Polygon2(@fighter_poly, 12, 1, ship_x, ship_y )

    ' END RENDERING SECTION ///////////////////////////////////////////////////

    ' wait a moment to reduce flicker
    repeat 5000
