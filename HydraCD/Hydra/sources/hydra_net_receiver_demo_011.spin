...
'///////////////////////////////////////////////////////////////////////
 ...
 ' BEGIN GAME LOOP ////////////////////////////////////////////////////
  ...
  repeat 
    curr_key := Receive_Data_Hydra_Net(8, CLOCKS_PER_BIT)
...
' framed up with a leading 0 start bit, and a tailing 1 stop bit
  ...
  end_cnt := CNT + (clks_bit >> 1)
   ...
   ' wait for counter to reach midway count of start bit frame
   waitcnt(end_cnt)             

   ' update end count for next iteration, one entire bit length
   end_cnt += clks_bit
...
parallax_string         byte    "Hydra-Net RECV v1.1",0         'text
blank_string            byte    "        ",0
'///////////////////////////////////////////////////////////////////////
' WORK AREA SECTION ////////////////////////////////////////////////////
'///////////////////////////////////////////////////////////////////////