...
' This version supports maps that are exactly 16x12 only but allows you to scroll
' within the 16x12 map (+-5 tiles horizontally) with the gamepad
'
' VERSION: 1.0
...
tile_data:      "pitfall_tile_data.spin" ' <----- MODIFY THIS LINE BY INSERTING YOUR OWN MAP2SPIN OUTPUT FILE HERE!!!!!
