...
repeat while 1
  ...
  repeat while ((tile_status_bits_parm & 1) == 0)
  ...
  repeat while ((tile_status_bits_parm & 1) == 1)
  tile_map0[(x+y<<4)<<1] := 1
...
' of code before, but unintelligble, this is much easier to understand! Now its like 90-95 lines :)
...
Vsync_Pulse
              ...
              mov       r0, #TSB_VSYNC
              or        r0, TSB_REGION_VSYNC            ' set region to vsync as well
...
v_phvis       long      %%3210_0123_3333_3333   ' 16-pixels, read low to high is rendered left to right, 2 bits per pixel
                                                ...
                                                ' and luma
' the colors used, 4 of them always
                        'grey, color 3 | dark grey, color 2 | blue, color 1 | green, color 0
v_choverscan  long      $06_04_0B_CB            ' each 2-bit pixel below references one of these 4 colors, (msb) 3,2,1,0 (lsb)
