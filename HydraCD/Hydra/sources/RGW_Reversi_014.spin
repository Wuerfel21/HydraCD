...
CON
  ...
  PALETTE_GAME      = %1100_1_011__0001_1_011__0000_0_111__0100_0_100
...
PRI RedrawGameBoard | lTemp1,lTemp2, lTemp3
   ...
   ' Draw Score literals
   DrawText(@LBL_SCORE1_LIT,0,-1)
   DrawText(@LBL_SCORE2_LIT,0,-1)
...
' above all others.
PRI FindMove : rFound | lCount, lCountMax, lRow,lCol, lIndex
    
    lCount := lCountMax := 0
    rFound := FALSE
    repeat lRow from 0 To GRID_LOOP
...
PRI CountGridSection(pCol, pRow, pColStep, pRowStep, pGridID, pRedraw) : rCount | lRow, lCol, lIndex, lFound
   ...
   ' Then we are done.
   ' Once we find a stone of the correct type then we are dont scanning.
