' /////////////////////////////////////////////////////////////////////////////
' TITLE: tracking_demo_002.spin - tracking techniques demo
'
' DESCRIPTION: This demo shows off the basic deterministic chasing and evasion
' algorithm augmented with a radius of influence and a timer that controls how
' long the last trajectory is used to track
'
' VERSION: 1.0
...
CON
  ...
  MIN_AI_REACTION_DIST = 5_000 ' AI will not activate unless player is within this distance
...
long x, y, dx, dy, tx, ty, index, dir, tile_map_index,dist      ' demo working vars
...
long alien_dx, alien_dy                                 ' tracking vector
long alien_frame, alien_frame_counter                   ' used for animation

' AI stuff
long ai_mode                                            ' mode AI is in evade or chase
long ai_counter                                         ' used as timer/counter to re-evaluate targeting vector
