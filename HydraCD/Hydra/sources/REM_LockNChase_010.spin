 ...
 ********************************
 ...
 - There is no sound or music yet: maybe in a future version
 - There is a bug that can trap a policeman into its own starting door. Use it as your advantage! ;)
 - There is also a bug where a policeman can stay stuck in a corner: he'll move if you go near him.
...
OBJ
  ...
  tv    : "tv_drv_010.spin"
  rem   : "REM_lnc_asm_010.spin"
  rem2 : "REM_lnc_proc_010.spin"
  rem3 : "REM_lnc_police_010.spin"
