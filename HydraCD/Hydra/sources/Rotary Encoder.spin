...
''**************************
''
''Reads 1 to 16 two-bit gray-code rotary encoders and provides 32-bit absolute position values for each and optionally provides delta position support
...
'THEORY OF OPERATION:
'Column 1 of the following truth table illustrates 2-bit, gray code rotary encoder output (encoder pins A and B) and their possible transitions (assuming
