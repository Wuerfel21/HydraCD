  ...
  ' HANDLE GAME STATES
    case game_state
      GAMESTATE_INIT:                                   ' INITIALIZATION        ////////////////                                                                                        
        ...
        gr.clear
        gr.colorwidth(3,14)
        gr.box(-45,-11,216,180)
        gr.colorwidth(1,14)
        gr.box(-46,-10,216,180)
        ...
        if(sound_play==1 and frame>frame_counter+60)
          ...
          gr.box(-9,-11,150,180)
          gr.color(1)
          gr.box(-10,-10,150,180)
          gr.colorwidth(3,6)                                      
          gr.box(93, SCREEN_HEIGHT/2 + 40, 37, 11)                ' score                               
          gr.box(93, SCREEN_HEIGHT/2 + 10, 37, 11)                ' lines
          gr.box(93, SCREEN_HEIGHT/2-35, 37, 37)                  ' next block
            ...
            repeat i from 0 to 3       ' check if tile is about to hit another tile
              repeat j from 0 to 9
               ...
               if(dy==0)
                 ...
                 j:=9
                 i:=3
            if(status==1 and y0<5 and (dy:=Check_Bottom(y0,dy))==0)
              status:=2
            y0-=dy
...
PUB Update_Score   
    ...
    gr.box(92, SCREEN_HEIGHT/2 + 41, 37, 11)
...
PUB Update_Lines   
    ...
    gr.box(92, SCREEN_HEIGHT/2 + 11, 37, 11)
...
PUB Draw_Block(tile)|i,j,k
  gr.colorwidth(0,6)                                ' blank out line region
  gr.box(92, SCREEN_HEIGHT/2-34, 37, 37)
  ...
  repeat i from 0 to 3
    ...
    repeat j from 0 to 4 step 2
      ...
      if((byte[tile+i]>>(4-j))&1==1)
        gr.colorwidth(3,0)
        gr.box(86+k*8,SCREEN_HEIGHT/2-8-i*8,8,8)

PUB New_Tile: retval|i
  i:=Rand//7
  case i
       0:
         retval:=@ZT
