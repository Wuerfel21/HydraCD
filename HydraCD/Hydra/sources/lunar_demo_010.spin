...
' VERSION 1.0
' COMMENTS: use mouse to rotate ship
'
' CONTROLS: mouse, keyboard, gamepad (must be plugged in)
' 
'
'
' //////////////////////////////////////////////////////////////////////
    ...
    case game_state
      ...
      GAME_STATE_RUN, GAME_STATE_MENU: ' the game is running...
        ...
        if (game_state == GAME_STATE_RUN)
          ...
          if (-key.keystate(KB_RIGHT_ARROW) == 1 or (nes_buttons & NES_RIGHT))
            lander_angle -= ANG_10
          else
          if (-key.keystate(KB_LEFT_ARROW) or (nes_buttons & NES_LEFT))
            lander_angle += ANG_10
        ...
        if (game_state == GAME_STATE_RUN)
          ...
          if (mouse.button(THRUST_BUTTON_ID) or -key.keystate(KB_UP_ARROW) or (nes_buttons & NES_B))
        ...
        if (game_state == GAME_STATE_MENU)
          ...
          if (mouse.button(FIRE_BUTTON_ID) or -key.keystate(KB_SPACE)  or (nes_buttons & NES_START))
       ...
       if (game_state == GAME_STATE_RUN)
         ' first draw thruster
         if ( (mouse.button(THRUST_BUTTON_ID) or key.keystate(KB_UP_ARROW) or (nes_buttons & NES_B)) and (Rand & $01))
           gr.colorwidth(2,0)
...
parallax_string         byte    "Mars Lander",0         'text
