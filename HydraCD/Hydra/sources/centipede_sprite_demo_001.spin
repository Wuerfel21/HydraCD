' /////////////////////////////////////////////////////////////////////////////
' TITLE: CENTIPEDE_SPRITE_DEMO_001.SPIN
'
' DESCRIPTION: Draws a random mushroom patch on screen where each mushroom has
' its own palette, then allows player to move around a "bug blaster",
' but no collision etc.  
'
' VERSION: x.x
...
' COMMENTS:
'
' CONTROLS: Uses gamepad, use DPAD to move around
'
'//////////////////////////////////////////////////////////////////////////////
