'///////////////////////////////////////////////////////////////////////
' 
'' EEPROM Driver for 128k serial eeprom (AT24C1024) (Non-Dedicated COG Version)
'' AUTHOR: Nick Sabalausky
'' LAST MODIFIED: 2.26.06
'' VERSION 1.0
'' 
'' NOTE: This file is NOT meant to be imported directly. It is
''       intended to be cut-and-pasted into another ASM program
''       when you do not want to use up an extra COG.
'' 
''       See the "To use on a non-dedicated COG through ASM" section
...
'test_val                long    %01010101_01010101_01010101_010101010
