...
' #1, _setup, _color, _width, _plot, _line, _arc, _vec, _vecarc, _pix, _pixarc, _text, _textarc, _textmode, _fill, _loop
  #1, _setup, _color, _width, _plot, _line,  _pix, _pixarc, _text, _textarc, _textmode,  _loop
...
' RGW New Mode param, 0 = Normal, Bit 0 = XOR When drawing
PUB pix(x, y, pixrot, pixdef_ptr, pMode)
